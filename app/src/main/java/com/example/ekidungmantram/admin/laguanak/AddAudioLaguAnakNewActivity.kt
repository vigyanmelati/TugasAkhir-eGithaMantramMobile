...
//        bundle.putString("desc_lagu_anak_admin", desc_lagu_anak)
    ...
    private fun validateInput(): Boolean {
        ...
        if(audio_file_text_add_lagu_anak.visibility   == View.GONE){
...
//                selectAudioLaguAnakUserNew.text = path.toString()
                audio_file_text_add_lagu_anak.visibility   = View.VISIBLE
                audio_file_text_add_lagu_anak.text = file!!.name
            }
