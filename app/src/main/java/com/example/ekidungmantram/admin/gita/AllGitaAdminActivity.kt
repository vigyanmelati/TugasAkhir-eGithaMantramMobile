package com.example.ekidungmantram.admin.gita
...
class AllGitaAdminActivity : AppCompatActivity() {
    ...
    private fun showRecyclerList() {
        ...
        val listGitaAdapter = AllGitaAdapter(list,  object : AllGitaAdapter.OnAdapterAllGitaListener{
            override fun onClick(result: AllGitaModel) {
                val intent = Intent(this@AllGitaAdminActivity, AllKidungAdminActivity::class.java)
